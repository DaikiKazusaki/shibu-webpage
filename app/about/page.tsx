          ...
          <section className="bg-white rounded-xl shadow-sm overflow-hidden">
            <div className="grid grid-cols-1 lg:grid-cols-2">
              ...
              <div className="p-8 lg:p-12 flex flex-col justify-center">
                ...
                <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                  定期的に将棋大会や教室を開催し、学生たちに実践の場を提供しています。
                  初心者向けの入門教室から、上級者向けの研究会まで、レベルに合わせた
                  プログラムを用意しています。また、プロ棋士を招いた特別講座なども
                  実施し、より高度な技術や知識を学ぶ機会も設けています。
                </p>
                <Link
                  href="/activities"
                  className="inline-flex items-center px-5 py-2.5 bg-gray-800 text-white rounded-lg hover:bg-gray-700 transition-colors w-fit"
          ...
          <section className="bg-white rounded-xl shadow-sm overflow-hidden">
            <div className="grid grid-cols-1 lg:grid-cols-2">
              <div className="order-2 lg:order-1 p-8 lg:p-12 flex flex-col justify-center">
                ...
                <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                  学校や地域のイベント、企業研修などに将棋講師を派遣しています。
                  将棋を通じてコミュニケーション能力や思考力を養うプログラムを
                  提供し、教育現場や企業研修でも好評をいただいています。
                  経験豊富な講師陣が、対象者のレベルや目的に合わせた指導を行います。
                </p>
                <Link
                  href="#"
                  className="inline-flex items-center px-5 py-2.5 bg-gray-800 text-white rounded-lg hover:bg-gray-700 transition-colors w-fit"
